        ...
        binding.apply {
            detailViewModel.apply {
                detail.observe(viewLifecycleOwner) {
                    Picasso.get().load(it.poster).into(mainMovieImage)
                    Picasso.get().load(it.poster).into(secondaryMovieImage)
                    movieName.text = it.title
                    movieRate.text = it.imdbRating
                    movieDate.text = it.released
                    movieLength.text = it.runtime
                    summaryTxtInfo.text = it.plot
                    actorsTxtInfo.text = it.actors
